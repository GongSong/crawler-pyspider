...
from backstage_data_migrate.page.tmall_huoniu_inventory import HuoniuInventory
...
class HuoniuOnsale(BaseCrawl):
    """
    发送获取天猫火牛 出售中的商品 的下载请求
    """
    ...
    def __init__(self, username, delay_second=None):
        super(HuoniuOnsale, self).__init__()
    ...
    def parse_response(self, response, task):
        try:
            ...
            if status == 1:
                ...
                # failed
                print('failed')
                self.crawl_handler_page(HuoniuOnsale(self.__username, delay_second=60))
