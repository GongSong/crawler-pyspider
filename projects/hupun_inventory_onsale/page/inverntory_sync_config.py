...
class InventorySyncConfig(Base):
    """
    ...
    def __init__(self, item, shop_uid, outer_product_id=''):
        super(InventorySyncConfig, self).__init__()
        self.__item = item
                ...
                for _item in result['data']['data']:
                    ...
                    if _item['title'].startswith('秒')  or \
                        ...
                        if _item['itemID'] == self.__outer_product_id:
                            ...
                            item_list.append({'item_id': item_id, 'upload_status': upload_status})
                    else:
                        item_id = _item['itemID']
                        upload_status = _item['upload']
                        item_list.append({'item_id': item_id, 'upload_status': upload_status})
...
if __name__ == '__main__':
    a = InventorySyncConfig('0829L60010', 'D991C1F60CD5393F8DB19EADE17236F0', '').use_cookie_pool().get_result()
    print(a)