...
class Supplier(Base):
    PATH = '/erp/base/supplier/query'
    """
    供应商 的数据抓取
    """

    def __init__(self, to_next_page=False, post_data=None):
        super(Supplier, self).__init__(self.PATH, post_data)
    ...
    def crawl_next_page(self):
        ...
        self.crawl_handler_page(Supplier(to_next_page=self.__to_next_page, post_data=post_data))
        pass
        # if self._post_data:
