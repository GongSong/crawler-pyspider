...
class OrderRefund(Base):
    PATH = '/erp/open/return/order/query'
    """
    售后单 的数据抓取
    """

    def __init__(self, to_next_page=False, post_data=None):
        super(OrderRefund, self).__init__(self.PATH, post_data)
    ...
    def crawl_next_page(self):
        ...
        self.crawl_handler_page(OrderRefund(to_next_page=self.__to_next_page, post_data=post_data))
        pass
        # if self._post_data:
