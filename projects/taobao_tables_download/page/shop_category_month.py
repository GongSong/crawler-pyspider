...
class ShopCategoryMonth(BaseCrawl):
    ...
    def parse_response(self, response, task):
        ...
        if is_success is False:
            ...
            self.crawl_handler_page(ShopCategoryMonth(self.__file_name,
                                                      self.__start_date,
                                                      self.__end_date,
                                                      self.__username,
                                                      self.__channel,
